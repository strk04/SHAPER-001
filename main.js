...
const SLIDERS = {
  ...
  wordsPerRow: { label: 'Paraules per línia', def: 0 },
  // --- Per caràcter ---
  ...
  // --- 3D: Form ---
  formSize: { label: 'Mida de forma', def: 0 },
  aspect: { label: 'Proporció', def: 0 },
  facets: { label: 'Cares', def: 0 },
  turns: { label: 'Voltes', def: 0 },
  count: { label: 'Quantitat', def: 0 },
  scatter: { label: 'Dispersió', def: 0 },
  // --- 3D: Camera ---
  fov: { label: 'Camp visual', def: 0 },
  zoom: { label: 'Zoom', def: 0 },
  ...
  // --- 3D: Per-region atom ---
  capsFontScale:     { label: 'Tapes — Mida', def: 0 },
  capsOpacity:       { label: 'Tapes — Opacitat', def: 0 },
  interiorFontScale: { label: 'Interior — Mida', def: 0 },
  interiorOpacity:   { label: 'Interior — Opacitat', def: 0 },
  // --- Morph ---
